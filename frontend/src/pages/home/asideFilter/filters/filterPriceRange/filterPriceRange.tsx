...
export function FilterPriceRange() {
  ...
  const handleMinInputFocus = () => {
    if (isMinInputEmpty) {
      setValues([0, values[1] > MAX ? MAX : values[1]]);
    }
  };

  const handleMaxInputFocus = () => {
    if (isMaxInputEmpty) {
      setValues([values[0] < MIN ? MIN : values[0], 0]);
    }
  };
        ...
        <div className="price-input">
          <div className="field">
            <CurrencyInput
              className="input-min"
              value={
                isMinInputEmpty && values[0] !== null && values[0] !== undefined
                  ? ""
                  : values[0].toString()
              }
          ...
          <div className="field">
            <CurrencyInput
              className="input-max"
              value={
                isMaxInputEmpty && values[1] !== null && values[1] !== undefined
                  ? ""
                  : values[1].toString()
              }
